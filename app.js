...
mongoose.connect(process.env.MONGO_URL);  //This connects you to Mongo db atlas
...
app.listen(port, () => console.log(`Server is running on port ${port} and database is connected successfully`));